...
for p in a.patches:
    plt.annotate(
        format(p.get_height() / sums[i] * 100, ".0f") + "%",
        (p.get_x() + p.get_width() / 2.0, p.get_height() / 2 - 0.2),
        ha="center",
        va="center",
        size=7,
        xytext=(0, 0),
...
for p in b.patches:
    plt.annotate(
        format(p.get_height() / sums[j] * 100, ".0f") + "%",
        (p.get_x() + p.get_width() / 2.0, p.get_height() / 2 + ece[j] - 0.2),
        ha="center",
        va="center",
        size=7,
        xytext=(0, 0),
